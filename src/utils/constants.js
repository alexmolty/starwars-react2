...
export const dreamTeam = [friend4, friend8, friend7, friend1, friend2, friend3, friend5, friend9, friend6];
...
export const personFields = [{key: `name`, label: `Name`}, {key: `gender`, label: `Gender`}, {
    key: `skin_color`,
    label: `Skin color`
}, {key: `hair_color`, label: 'Hair color'}, {key: `height`, label: `Height`}, {
    key: `eye_color`,
    label: `Eye color`
